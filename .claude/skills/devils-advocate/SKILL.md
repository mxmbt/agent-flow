...
You receive the Design Document draft (after /tech-review, before Codex review). Your input includes:
...
- **Multi-tenancy** (особенно важно для ZNAI — organizationId на всех Prisma queries)
...
- Communicate in Russian when reviewing ZNAI plans (match project language).
