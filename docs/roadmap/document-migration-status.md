...
**Status:** Empty package baseline; FinAI reference inventory populated; first nineteen agent migrations, first seven guide migrations, core-linked static skills, core phase/lifecycle skills, product/tech/refactor/TDD/UX-copy/verification review skills, brainstorming, systematic-debugging, and devil's-advocate skill bundles, code-review-graph/code-review-toolkit/nextjs helper skills, seven design pack skill bundles, and core artifact templates validated and universalized
...
| File-by-file migration tasks | Started | 30 tasks | One task per source file or approved micro-batch | Agent migration now has three single-agent tasks and eight two-agent micro-batches; guide migration has three two-guide micro-batches; design migration has two approved skill-bundle batches plus slides; core-linked auxiliary skills, core phase skills, lifecycle phase skills, product/tech/refactor/TDD/UX-copy/verification review, brainstorming, systematic-debugging, devil's advocate, code-review-graph/code-review-toolkit/nextjs helper skills, and core artifact templates each have approved bundle/single-file tasks. |
| Classified rows | Dry-run started | 251 rows | 537 rows | Classification applies only after full-file review; current sample covers root target, nineteen agents, seven guides, core-linked static skills, core phase/lifecycle/product/refactor/TDD/UX-copy/verification review skill files, the brainstorming and systematic-debugging bundles, devil's-advocate bundle, code-review-graph/code-review-toolkit/nextjs helper skills, flow-infra-sync/desloppify reviews, seven design pack skill bundles, one stale coverage artifact, lifecycle skill, and five core artifact templates. |
| Migrated rows | Started | 240 rows | TBD | `FINAI-0002` through `FINAI-0027` except `FINAI-0001`, plus the migrated core-linked static skill rows, core phase/lifecycle/product/refactor/TDD/UX-copy/verification review skill rows, brainstorming and systematic-debugging bundle rows, devil's-advocate bundle rows, code-review-graph/code-review-toolkit/nextjs helper skill rows, design skill bundle rows, and core artifact template rows, have targets and pass the similarity gate. Core agent/guide/templates pass the universality scan; finance, code-review-toolkit, code-review-graph, nextjs, UI/UX Pro Max, brand, banner, slides, and comprehensive design assets are pack content. |
| Universality scan | Passing | 108 files | Passing in CI | Reports project/runtime/stack/domain assumptions during baseline review; current migrated core and project-agnostic pack agent/guide/static skill templates have been universalized. Finance pack agent content is excluded from the core universality manifest. |
...
| Auxiliary skills/guides | debugging, TDD, frontend, e2e, commit, architecture, design | 5 core guides, 2 pack guides, 39 core static skill bundles, 4 pack single-file skills, and 9 pack skill bundles migrated and validated | Continue one guide or approved micro-batch per task; route optional-tool and vendor-derived guides through packs unless a core agent directly links to the skill. |
