...
python {{target.skillRoot}}/design-system-uupm/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python {{target.skillRoot}}/design-system-uupm/scripts/search-slides.py "traction slide" \
