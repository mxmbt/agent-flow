...
python {{target.skillRoot}}/design-system-uupm/scripts/search-slides.py "investor pitch" -d strategy

# Get emotion arc
python {{target.skillRoot}}/design-system-uupm/scripts/search-slides.py "series a funding" -d strategy --json
```
