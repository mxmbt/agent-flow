...
**Font integration:**
- Use repo-local `./canvas-fonts` only if the directory is intentionally vendored in this repo
- Otherwise use system fonts or explicitly downloaded project fonts
