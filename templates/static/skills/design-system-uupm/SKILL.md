...
**Generate tokens:**
```bash
node .claude/skills/design-system-uupm/scripts/generate-tokens.cjs --config assets/design-tokens.json -o assets/design-tokens.css
```

**Validate usage:**
```bash
node .claude/skills/design-system-uupm/scripts/validate-tokens.cjs --dir web/src/
```
...
python .claude/skills/design-system-uupm/scripts/search-slides.py "investor pitch"

# Domain-specific search
python .claude/skills/design-system-uupm/scripts/search-slides.py "problem agitation" -d copy
python .claude/skills/design-system-uupm/scripts/search-slides.py "revenue growth" -d chart

# Contextual search (Premium System)
python .claude/skills/design-system-uupm/scripts/search-slides.py "problem slide" --context --position 2 --total 9
python .claude/skills/design-system-uupm/scripts/search-slides.py "cta" --context --position 9 --prev-emotion frustration
```
...
Working output root for generated slide decks:
```
assets/designs/slides/<deck-name>.html
```
