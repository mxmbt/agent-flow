---
provenance_class: exact_vendor
provenance_origin: vercel-labs/next-skills
upstream_sync_policy: exact
provenance_reference: docs/architecture/AI-SKILL-PROVENANCE.md
provenance_url: https://github.com/vercel-labs/next-skills
...
| Need | Use | NOT |
|------|-----|-----|
| Read data for rendering | Server Component + API server caller | Client-side fetch |
| User mutation | Server Action OR API mutation | Direct DB in component |
| External API webhook | Route Handler (`route.ts`) | Server Action |
| Real-time data | Client Component + API subscription | Polling in Server Component |
