...
Where AI coding assistants systematically fall short when writing, reviewing, and reasoning about software. This reference exists for self-awareness — to catch patterns in AI-generated work that humans should scrutinize.
