...
python .claude/skills/design-system-uupm/scripts/search-slides.py "metrics dashboard" -d layout

# Contextual recommendation
python .claude/skills/design-system-uupm/scripts/search-slides.py "traction slide" \
