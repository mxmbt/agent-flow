...
node .claude/skills/brand-uupm/scripts/validate-asset.cjs <path>
```

**Tokens:**
```bash
node .claude/skills/design-system-uupm/scripts/generate-tokens.cjs -c assets/design-tokens.json
node .claude/skills/design-system-uupm/scripts/validate-tokens.cjs -d web/src/
```
